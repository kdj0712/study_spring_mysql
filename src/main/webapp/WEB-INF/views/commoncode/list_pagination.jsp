            ...
            <div class="container mt-4">
                        ...
                        String search=(String) dataMap.getOrDefault("search",""); %>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" id="searchType" name="searchType">
                                    ...
                                    <option value="CODE_NAME" <%= "CODE_NAME".equals(searchType) ? "selected" : "" %>>CODE_NAME</option>
                                    <option value="DESCRIPTION" <%= "DESCRIPTION".equals(searchType) ? "selected" : "" %>>DESCRIPTION</option>
                                </select>
                ...
                <nav aria-label="Page navigation">
                    ...
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item"><button class="page-link" type="submit" name="currentPage"
                                value="${dataMap.nextPage}">Next</button>
                        </li>
                    </ul>
                </nav>
            </div>
